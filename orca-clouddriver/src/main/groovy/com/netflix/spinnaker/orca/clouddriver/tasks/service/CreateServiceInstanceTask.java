...
package com.netflix.spinnaker.orca.clouddriver.tasks.service;
...
@Component
public class CreateServiceInstanceTask extends AbstractCloudProviderAwareTask implements Task {
  ...
  public TaskResult execute(Stage stage) {
    ...
    Map<String, Map> operation = new ImmutableMap.Builder<String, Map>()
      .put("createServiceInstance", stage.getContext())
      .build();
    ...
    Map<String, Object> outputs = new ImmutableMap.Builder<String, Object>()
      .put("notification.type", "createServiceInstance")
