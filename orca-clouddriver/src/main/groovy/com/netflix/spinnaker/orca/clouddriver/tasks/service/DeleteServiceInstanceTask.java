...
@Component
public class DeleteServiceInstanceTask extends AbstractCloudProviderAwareTask implements Task {
  ...
  public TaskResult execute(Stage stage) {
    ...
    Map<String, Map> operation = new ImmutableMap.Builder<String, Map>()
      .put("deleteServiceInstance", stage.getContext())
      .build();
    ...
    Map<String, Object> outputs = new ImmutableMap.Builder<String, Object>()
      .put("notification.type", "deleteServiceInstance")
